table 50104 "NVR Sales Order Line"
{
    ...
    fields
    {
        ...
        field(501044;Quantity; Integer)
        {
            ...
            var
                Product : Record "NVR Products";
            begin
                if Product.Get("Quantity") then begin
                    if Product.StockQuantity < "Quantity" then begin
                        Error('Not enough stock available for this product. There currently only is %1 units in stock.',Product.StockQuantity);
                    end;
                end else begin
                    Unitprice := 0;
                end;
    ...
    //Might be used for defencive coding
    trigger OnInsert()
    begin
